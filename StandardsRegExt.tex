...
\todo{make this an appendix or so}

\lstinputlisting{StandardsRegExt.vor}
...
\href{http://www.ivoa.net/xml/StandardsRegExt/v1.0}{http://www.ivoa.net/xml/StandardsRegExt/v1.0}.\todo{No,
it's not, and I'll throw this out in the next commit}
...
\lstinputlisting{sia-example.vor}
